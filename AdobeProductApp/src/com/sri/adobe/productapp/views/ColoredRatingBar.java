package com.sri.adobe.productapp.views;
...
public class ColoredRatingBar extends View {
    ...
    private void init(Context context) {
        ...
        if(mType==SMALL){
            drawables = new Bitmap[]{BitmapFactory.decodeResource(res, R.drawable.star_green_small),BitmapFactory.decodeResource(res, R.drawable.star_orange_small),BitmapFactory.decodeResource(res, R.drawable.star_green_small)};
            progressBackground = BitmapFactory.decodeResource(res, R.drawable.star_black_small);
        }else{
            drawables = new Bitmap[]{BitmapFactory.decodeResource(res, R.drawable.star_green),BitmapFactory.decodeResource(res, R.drawable.star_orange),BitmapFactory.decodeResource(res, R.drawable.star_green)};
